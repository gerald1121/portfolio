      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8">
        <div className="flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start">
          ...
          <p className="text-gray-300 py-4 max-x-md text-justify">
            adept in full-stack development, possessing excellent communication,
            problem-solving, leadership, collaboration, adaptability, time
            management, attention to detail, analytical thinking, continuous
            learning, and mentoring abilities, dedicated to delivering
            high-quality solutions and fostering team success.
          </p>
